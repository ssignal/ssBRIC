...
const BLOCKS = [
  {
    ...
    "colour": "#e91e63",
    "tooltip": "category test.",
    "helpUrl": ""
  }
];
const BLOCK_TOOLTIPS = {
  "behavior__touch__touch_touch": "category test."
};
...
function registerBlocks_ros2blocks_touch() {
...
window.BRIC.blockRegistrars.push(registerBlocks_ros2blocks_touch);
